      ...
      if (currentState === "Sign Up") {
        ...
        if (response.data.success) {
          if (response.data.requiresVerification) {
            // User needs to verify email - navigate to verification page
        ...
        if (response.data.success) {
          ...
          // User exists but email not verified - navigate to verification page
  ...
  return (
    ...
    >
      ...
      <button
        ...
        } text-white font-light px-8 py-2 mt-4 rounded-3xl flex items-center justify-center gap-3 transition-colors`}
      >
        {isLoading && (
